...
const Sidebar: React.FC<Props> = ({ theme, onThemeToggle, userName = 'User', userAvatar }) => {
      ...
      <div className="sidebar-inner">
        ...
        <div className="sidebar-logo">
          <div className="sidebar-logo-icon">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
              <path d="M6 12 C6 8 8.5 6 12 6 C15.5 6 18 8 18 10.5 C18 13 16 14.5 14 14.5 L10 14.5 C8 14.5 6 16 6 18" stroke="white" strokeWidth="2.2" strokeLinecap="round" fill="none"/>
            </svg>
          </div>
          <span className="sidebar-logo-text">Coinbridge</span>
        </div>
        ...
        <div className="sidebar-user">
          ...
          <div className="sidebar-user-info">
            ...
            <span className="sidebar-user-role">{isAdmin ? 'Administrator' : 'Personal'}</span>
          </div>
          <button
