...
const NETWORKS: Network[] = [
  {
    ...
    confirmations: 12,
    minDeposit: 0.01,
    address: "0x742d35Cc6634C0532925a3b8D4C9D5f8B3e8B2e",
    color: "#627EEA",
  },
  {
    id: "btc",
  ...
  },
  {
    ...
    confirmations: 15,
    minDeposit: 0.005,
    address: "0x8a5B3dE58A3F4C0532925a3b8D4C9D5f8B3e2a4f",
    color: "#F3BA2F",
  },
  {
    id: "trc20",
    ...
    confirmations: 20,
    minDeposit: 10,
    address: "TQcGPvpnR2A1a3BqTdPbU8cGLFX7aKjm3s",
    color: "#FF4D4D",
  },
];
        ...
        <div className="dp-card">
              ...
              {open && (
                <div className="dp-menu">
                  {NETWORKS.map((n) => (
                    <button
                      key={n.id}
                      className={`dp-option ${n.id === netId ? "dp-option--active" : ""}`}
                      onClick={() => {
                        setNetId(n.id);
                        setOpen(false);
                      }}
          ...
          <div className="dp-section">
            ...
            <div className="dp-addr-box">
              {qr ? (
                <div className="dp-qr">
                  <QRCode value={net.address} color={net.color} />
          ...
          <div className="dp-details">
            {[
              ...
              },
              {
                ...
                value: `${net.minDeposit} ${net.symbol.split(" ")[0]}`,
              },
          ...
          <div className="dp-warn">
            ...
            <p>
              ...
              to this address. Sending any other asset will result in permanent
              loss.
            </p>
          </div>
        </div>
